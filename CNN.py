...
use_synthetic_train_data = False
num_synthetic = 0
...
# --- Model Definition ---
def build_cnn_model(input_shape=(105, 105, 1), num_hidden=96, num_labels=1, depth=64):
    model = Sequential()
...
for fold in range(k_folds):
    ...
    log_fold_results_to_pickle(fold, metrics, path="results/final_results/original_training/fold_metrics_CNN_partial.pkl")
...
plot_confusion_matrix(conf_matrix_percent, class_names=["SZ", "BP"], title="CNN")
